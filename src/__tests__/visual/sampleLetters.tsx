...
export const LongLetter = ({
  ...
  >
    <LetterBlock
      content="# Multi-Page Letter Test
 ...
 */
export const CustomTypographyLetter = ({
  onReady,
}: {
  onReady?: (download: () => void) => void;
}) => (
...
This content is left-aligned, which is the default alignment for letter content."
      textAlign="left"
    />
...
This content is center-aligned to demonstrate alignment options."
      textAlign="center"
    />
...
This content is right-aligned for testing purposes."
      textAlign="right"
    />
    ...
    <LetterBlock
      content="#### Full Justification

This content uses full justification, which spreads the text evenly across the line width. This is useful for formal documents that require a professional appearance with aligned left and right margins."
      textAlign="full"
    />
  </GcLetter>
);
...
export const FormattedLetter = ({
  ...
  >
    <LetterBlock
      content="# Letter with Formatting
...
export const PageTypeLetter = ({
  ...
  >
    <LetterBlock
      content={`# ${pageType.toUpperCase()} Page Type
 ...
 */
export const LongParagraphLetter = ({
  onReady,
}: {
  onReady?: (download: () => void) => void;
}) => {
  const longText = Array(200)
    .fill(
      'This is a very long paragraph with repeated content to test text wrapping and page breaking with continuous content.'
    )
    .join(' ');
